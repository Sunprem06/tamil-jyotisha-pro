      ...
      <main className="flex-1 py-8">
        <div className="container max-w-3xl">
          ...
          <div className="rasi-card space-y-4">
            <p className="font-tamil leading-relaxed">ஆன்மீகத் துணை என்பது வேத ஜோதிட அறிவியலை நவீன தொழில்நுட்பத்துடன் இணைத்து வழங்கும் ஒரு முழுமையான ஆன்மீக வழிகாட்டி தளமாகும்.</p>
